...
@torch.no_grad()
def sample_diffusion_ligand_decomp( # prior mode here is the default if its not specified in the sampling.yml
...
# python sample_diffusion_decomp.py --ckpt_path /home/amna.alhosani/DecompDiff/logs_diffusion_full/training_2023_10_16__19_59_05/checkpoints/2000.pt
