...
if __name__ == '__main__':
    ...
    with Pool(args.num_workers) as p:
        ...
        for (r, pd, bd) in tqdm(p.starmap(partial(eval_single_datapoint, args=args),
                                zip(test_index[start_sample:args.eval_num_examples], list(range(start_sample, args.eval_num_examples)))),
                      total=args.eval_num_examples - start_sample, desc='Overall Eval'):
